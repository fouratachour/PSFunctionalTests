...
describe('Email SMTP configuration in Back Office', function () {
    ...
    describe('Configuration of SMTP mail server', function (done) {
        ...
        it('should go to Advanced Parameters', function(done){
            global.fctname= this.test.title;
            this.client
                .moveToObject(this.selector.EmailConfigPage.advanced_parameter_button)
                .click(this.selector.EmailConfigPage.email_setting_button)
                .waitForExist(this.selector.EmailConfigPage.email_seeting_menu,10000)
                .pause(3000)
                .call(done);
        });
        ...
        it('should update the new smtp Parameters', function(done){
            global.fctname= this.test.title;
            this.client
                .waitForExist(this.selector.EmailConfigPage.custum_SMTP_parameter_radio,10000)
        ...
        it('should send email test', function(done){
            global.fctname= this.test.title;
            this.client
                .click(this.selector.EmailConfigPage.send_email_button)
                .waitForExist(this.selector.EmailConfigPage.mail_result_block, 90000)
                .pause(2000)
                .getText(this.selector.EmailConfigPage.mail_result_block).then(function(text) {
    ...
    describe('log into SMTP page', function (done) {
        it('should check the recived email', function(done){
            ...
            this.client
                ...
                .waitForExist(this.selector.EmailConfigPage.last_received_mail, 90000)
                .click(this.selector.EmailConfigPage.last_received_mail)
                .getText(this.selector.EmailConfigPage.test_received_mail).then(function(text) {
                    var my_text_check = text;
